...
* [Scan application code](scan-application-code/README.md)
  ...
  * [Snyk Code](scan-application-code/snyk-code/README.md)
    ...
    * [Using Snyk Code via the CLI](scan-application-code/snyk-code/cli-for-snyk-code/README.md)
      ...
      * [Publishing CLI results to a Snyk Project and ignoring CLI results (beta)](scan-application-code/snyk-code/cli-for-snyk-code/publishing-cli-results-to-a-snyk-project-and-ignoring-cli-results.md)
...
* [Scan containers](scan-containers/README.md)
  ...
  * [Using Snyk Container](scan-containers/using-snyk-container/README.md)
    ...
    * [Custom Base Image Recommendations](scan-containers/using-snyk-container/custom-base-image-recommendations.md)
    * [Custom Versioning Schema for Custom Base Images](scan-containers/using-snyk-container/custom-versioning-schema-for-custom-base-images.md)
...
* [Enterprise setup](enterprise-setup/README.md)
  ...
  * [Set up Single Sign-On (SSO) for authentication](enterprise-setup/set-up-single-sign-on-sso-for-authentication/README.md)
    * [Choose a provisioning option](enterprise-setup/set-up-single-sign-on-sso-for-authentication/choose-a-provisioning-option.md)
    * [Set up Snyk Single Sign-On (SSO)](enterprise-setup/set-up-single-sign-on-sso-for-authentication/set-up-snyk-single-sign-on-sso.md)
    * [Self Serve Single Sign-On (SSO)](enterprise-setup/set-up-single-sign-on-sso-for-authentication/self-serve-single-sign-on-sso/README.md)
      * [Example: Okta SAML Application](enterprise-setup/set-up-single-sign-on-sso-for-authentication/self-serve-single-sign-on-sso/example-okta.md)
      * [Example: Azure AD Enterprise Application](enterprise-setup/set-up-single-sign-on-sso-for-authentication/self-serve-single-sign-on-sso/example-azure-ad-enterprise-application.md)
      * [Example: Google Workspace](enterprise-setup/set-up-single-sign-on-sso-for-authentication/self-serve-single-sign-on-sso/example-google-workspace.md)
    * [Custom Mapping Option](enterprise-setup/set-up-single-sign-on-sso-for-authentication/custom-mapping-option/README.md)
      ...
      * [Example: Setting up custom mapping for Azure AD](enterprise-setup/set-up-single-sign-on-sso-for-authentication/custom-mapping-option/example-setting-up-custom-mapping-for-azure-ad.md)
